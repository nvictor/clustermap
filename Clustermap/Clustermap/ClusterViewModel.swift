...
final class ClusterViewModel: ObservableObject {
    ...
    @Published var root: TreeNode = TreeNode(name: "Welcome", value: 1, children: [], maxSubtreeLeafValue: 1, leafNodeCount: 1)
    ...
    func loadCluster() async {
        ...
        case .failure(let error):
            self.root = TreeNode(name: "Error", value: 1, children: [], maxSubtreeLeafValue: 1, leafNodeCount: 1)
